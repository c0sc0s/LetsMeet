...
var MCPClient = /** @class */ (function () {
    function MCPClient(_a) {
        var name = _a.name, _b = _a.version, version = _b === void 0 ? "1.0.0" : _b, command = _a.command, _c = _a.args, args = _c === void 0 ? [] : _c, _d = _a.env, env = _d === void 0 ? {} : _d;
        this.transport = null;
        this.tools = [];
        this.command = '';
        this.args = [];
        ...
        this.mcp = new index_js_1.Client({ name: this.name, version: this.version });
    }
    ...
    MCPClient.prototype.connectToServer = function () {
